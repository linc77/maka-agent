# 01 — Alma thread title auto-generation
...
When `isAutoDetected: true`, alma picked the model without
...
3. **Language matching** — REPEATED with examples. Same idea
   alma teaches the bots (round-4 04) but the IMPORTANT prefix
...
Cross-ref round-4 [`07-websocket-sync.md`](../alma-deep-dive-yuejing-round-4/07-websocket-sync.md)
...
Cross-ref round-5 [`06-telemetry-sentry.md`](../alma-deep-dive-yuejing-round-5/06-telemetry-sentry.md)
...
seconds since start. This is alma's lightweight perf telemetry
